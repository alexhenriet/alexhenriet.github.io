...
<h3 id=".isregistered"><a href="index.js#L145">.isRegistered</a></h3>
...
<pre><code class="js">var app = new Base()
  .use(foo)
  .use(bar)
  .use(baz)
</code></pre>
...
<pre><code class="js">// create an instance of `Base`, this is our first ("base") instance
var first = new Base();
