...
<h3 id="%60tasktaskname%2C-fn%60"><code>task([taskName,] fn)</code></h3>
...
<h3 id="%60treeoptions%60"><code>tree([options])</code></h3>
...
<pre><code class="js">var Undertaker = require('undertaker');
