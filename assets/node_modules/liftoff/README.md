...
<h3 id="prepareopts%2C-callbackenv">prepare(opts, callback(env))</h3>
...
<h4 id="opts.require">opts.require</h4>
...
<h4 id="callbackenv%2C-argv">callback(env, argv)</h4>
...
<h4 id="requirename%2C-module">require(name, module)</h4>
